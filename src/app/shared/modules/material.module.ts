...
import {
  ...
  MatFormFieldModule, MatChipsModule, MatAutocompleteModule, MatDividerModule, MatGridListModule,
  MatSidenavModule, MatListModule, MatRadioModule, MatSliderModule, 
